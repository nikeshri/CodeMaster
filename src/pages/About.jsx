const aboutDetails = [
  `Welcome to CodeMaster, your ultimate destination for immersive coding quizzes! Our mission is to make coding education accessible to everyone by providing a diverse range of quizzes covering programming languages, algorithms, data structures, and more, all completely free of charge. `,

  `At CodeMaster, we believe that learning to code should be accessible to everyone, which is why we offer all of our quizzes for free. Whether you're a beginner or an experienced programmer, our quizzes are designed to help you improve your skills and stay up-to-date with the latest trends in the coding domain.`,
...
function About() {
  return (
    <div className="mx-auto flex w-[85%] animate-reveal flex-col items-center justify-center">
      <h1 className="page-heading">About Code Master</h1>
      ...
      <span className="mt-14 block font-semibold tracking-wide">
        ...
        <a
          ...
          href="https://www.nikeshmishra.com.np"
          rel="noreferrer"
          target="_blank"
        >
          Nikesh Mishra.
